    ...
    <>
      ...
      <Stack color={colors.grey[400]} direction={'column'} spacing={2} mt={2}>
        ...
        <Typography variant={'subtitle'}>
          ...
          designed to provide you with a solid foundation in web programming and
          equip you with the essential skills to build modern and interactive
        ...
        <Typography variant={'subtitle'}>
          ...
          the foundation of web communication. You will learn about the roles of
          clients (such as web browsers) and servers in the web ecosystem, and
          how they interact to deliver web content.
          <br />
        ...
        <Typography variant={'subtitle'}>
          ...
          In this section, we will cover the essentials of HTML, enabling you to
          create the content and structure of web pages.
          <br />
          <br />
          You will learn about HTML tags and elements, and how they are used to
          mark up and organize web content. Topics covered in this section
          include :
        </Typography>
        <ul>
...
<body>
  <!-- Content goes here -->
          ...
          <li>
            Building forms: Understand how to create interactive forms, collect
            user input, and handle form submissions
          </li>
...
<footer>
  <p>&copy; 2023 Your Company</p>
        ...
        <Typography variant={'subtitle'}>
          ...
          HTML and be able to create static web pages with proper structure and
          content.
        </Typography>
        ...
        <Typography variant={'subtitle'}>
          CSS (Cascading Style Sheets) is used to style and visually enhance web
          pages. In this section, we will dive into the fundamentals of CSS and
          explore how to apply styles to HTML elements.
          <br /> <br /> You will learn how to create visually appealing layouts
          and make your web pages come to life. Topics covered in this section
          include:
        </Typography>
        <ul>
          <li>
            Selectors and specificity: Understand how CSS selectors work and how
            to target specific elements on your web pages
          </li>
          <li>
            Styling properties: Learn how to change colors, fonts, backgrounds,
            borders, and other visual properties of HTML elements
          </li>
          <li>
...
nav ul {
  ...
  padding: 0;
        ...
        <Typography variant={'subtitle'}>
          By the end of this section, you will have a solid understanding of CSS
          and be able to style your web pages effectively.
        </Typography>
        <Typography
          sx={{ fontWeight: 700, fontSize: 28, color: colors.grey[300] }}
        >
        ...
        <Typography variant={'subtitle'}>
          JavaScript is a powerful programming language that adds interactivity
          and functionality to web pages. In this section, we will dive into the
          basics of JavaScript and explore its capabilities. <br /> <br />
        ...
        <ul>
          <li>
            ...
            variables, work with different data types, and perform operations in
            JavaScript
          </li>
          ...
          <li>
            ...
            events such as clicks, form submissions, and keyboard interactions.
          </li>
        </ul>
        <Typography variant={'subtitle'}>
          By the end of this section, you will have a solid understanding of
          ...
          <br />
          <br />
          These are the foundational topics that will provide you with a strong
          understanding of web development. As you progress through the course,
          you will build upon these fundamentals and explore more advanced
          concepts and technologies.
          <br />
          <br />
          Remember, practice and hands-on projects are crucial for mastering web
          development skills. So, be prepared to apply your knowledge by working
          on real-world examples and projects throughout the course.
          <br />
          <br />
        ...
        <Stack direction={'row'} justifyContent={'space-between'}>
          ...
          >
            ...
            <Typography fontSize={18} fontWeight={600} color={colors.blue[600]}>
              Roadmap Advanced >>
            </Typography>
          </Stack>
        </Stack>
